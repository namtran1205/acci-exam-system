    ...
    <div class="flex w-full flex-col gap-3">
      ...
      <div class="relative">
        <input
          ...
          class="w-full rounded-md border border-gray-300 py-2 px-4 shadow-sm focus:border-leaf focus:ring-leaf"
        />
      ...
      >
        ...
        />
        <div v-if="filteredCertificates.length === 0 && !loading" class="text-center py-4 text-gray-500">
